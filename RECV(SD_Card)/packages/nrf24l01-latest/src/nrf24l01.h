...
extern uint8_t RxBuf_P0[32];
extern uint8_t RxBuf_P1[32];
extern uint8_t RxBuf_P2[32];
extern uint8_t RxBuf_P3[32];
extern uint8_t RxBuf_P4[32];
extern uint8_t RxBuf_P5[32];
...
extern uint8_t nrf24_prx_run(void);
